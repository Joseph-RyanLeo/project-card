...
for r in before[em]:
 ...
 if n=='晶体化':
  detail='由小队生命和护甲生效卡承担，不分别触发。主动移除、属性降低归零也触发；0护甲不重复触发。新增生命与空白生命均转护甲，治疗不转换。护甲成长立即增加当前护甲；上限下降截断当前生命不算伤害。临时生命转换加成到期移除。'
